  ...
  return (
    room && (
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
        ...
        <form className="flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0_0_0_2px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl">
          <div className="flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 mdd:gap-10 text-gray-500">
            <div className="flex flex-col">
